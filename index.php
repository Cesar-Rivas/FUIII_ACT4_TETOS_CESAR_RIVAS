                        ...
                        <div class="col-md-3">
                            <h1>Datos del vehículo</h1>
                                <form action="insertar.php" method="POST">
                                    <input type="text" class="form-control mb-3" name="compañia" placeholder="Compañia">
                                    <input type="number" class="form-control mb-3" name="año" placeholder="Año">
